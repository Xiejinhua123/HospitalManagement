	...
	<div class="row">
        <div class="well col-md-5 center login-box">
        	<c:if test="${sessionScope.patient == null}">
	            <div class="alert alert-info">
	                    ...
	                    <div class="input-group input-group-lg">
	                        ...
	                        <input type="text" class="form-control name" placeholder="用户名/身份证号/手机号 ">
	                    </div>
            ...
            <c:if test="${sessionScope.patient != null}">
	            ...
	            <div>
	            	<button class="b">挂号</button>
        			<button class="b logout">注销</button>
        			</div>
            </c:if>
            <div style="margin-top:20px;">
	            <button class="b btn1">点击注册</button>
	        	<button class="b btn2">忘记密码</button>
	        </div>
        </div>
        <!--/span-->
